    ...
    def build_directive(
        ...
        if document_genre == DocumentGenre.BUSINESS_FINANCIAL:
            ...
            return (
                ...
                "9. Empirical Falsification Criteria, Staged Roadmap & Explicit Catalog of Unresolved Open Limits: Formulate explicit numbered falsification conditions, a staged engineering roadmap, and an explicit catalog of the 10 core theoretical bottlenecks/open problems.\n"
                "10. Ethical Asymmetry, Governance & Condensed Formal Mathematical Spine: Detail ethical risk profiles, suffering vs. phenomenality, the institutional safeguards (5 governance principles: scientific independence, financial transparency, open science, long-term orientation, conflict of interest), the distributed governance trigger (\\boxed{\\text{architect} \\neq \\text{sovereign}}), and compile the complete consolidated LaTeX equation block at the conclusion.\n\n"
                "STRICT FACTUAL GROUNDING LAWS:\n"
                ...
                "4. Maintain exhaustive academic depth, rigorous information density, and publication-grade LaTeX formatting throughout."
            )
