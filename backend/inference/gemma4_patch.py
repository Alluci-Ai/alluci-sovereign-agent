...
def apply_gemma4_patches():
    """
    Applies runtime monkeypatches to mlx_lm.models.gemma3n to support
    Gemma 4 architecture variants natively in MLX.
    Returns the custom_get_classes function required by load_model.
    """
