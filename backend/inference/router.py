...
class ModelRouter(ExecutiveRouter):
    ...
    def _prepare_system_instruction(self, prompt: str, system_instruction: str = "", session_id: Optional[str] = None) -> str:
        ...
        polytope_system_core = (
            ...
            "5. Communication & Completeness: When asked to list and explain your skills, tools, or capabilities, enumerate all 14 Skills and 15 Tools completely and accurately from the Authentic Manifests. Never hallucinate or omit items.\n"
