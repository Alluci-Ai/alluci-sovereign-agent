...
class ToolManifestSchema(BaseModel):
    name: str
    description: str
    capabilities: Dict[str, ExecutionSchema] = Field(default_factory=dict)
...
class IngestionDAG:
    ...
    async def run(self, urls: List[str], user_prompt: str, deep_crawl: bool = False) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        synth_prompt = (
            ...
            "Identify all available integration paths (API, CLI, RPC, MCP) and populate them into the capabilities dictionary.\n"
            "Schema:\n"
            "{\n"
            "  \"name\": \"Tool Name\",\n"
            "  \"description\": \"Description of tool\",\n"
            "  \"capabilities\": {\n"
            "     \"api\": {\"type\": \"API\", \"baseUrl\": \"...\", \"endpoint\": \"...\", \"method\": \"...\", \"sandboxed\": false},\n"
