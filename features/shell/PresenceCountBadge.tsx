    ...
    return (
        <div className="flex items-center gap-2 bg-glass-1 rounded-full border border-glass-edge px-2.5 h-6">
            <div className="flex items-center gap-1.5" title="Connected Client Instances">
                <Server size={10} className="text-[var(--accent)]" />
                <span className="text-[10px] font-mono font-medium text-[var(--text-primary)]">{presence?.instances || 1}</span>
            </div>
            ...
            <div className="flex items-center gap-1.5" title="Active Sessions">
                ...
                <span className="text-[10px] font-mono font-medium text-[var(--text-primary)]">{presence?.sessions || 1}</span>
            </div>
        </div>
    );
};
